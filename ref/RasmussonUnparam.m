...
figure('Color','w')
plot(t,a(:,[14,27,32,36,38,40,42,44,46,48,50,52,54,56,4,58,72]))
legend(["alpha_Na11","alpha_Na12","alpha_Na13","beta_Na11","beta_Na12", ...
    "beta_Na13","alpha_Na3","beta_Na3","alpha_Na2","beta_Na2","alpha_Na4", ...
    "beta_Na4","alpha_Na5","beta_Na5","CNa3 (C3)","I_Na","Volt"],'Location','bestoutside')

figure('Color','w')
plot(t,s(:,[20,21,22,23,24,25,26,27]))
...
function [RATES, ALGEBRAIC] = computeRates(t, STATES, CONSTANTS)
    ...
    ALGEBRAIC(:,72) = arrayfun(@(t) volt_clamp(t), t);

...
title("I_{Na}")
hold on
plot(t1,a1(:,16),'--','Color','black','LineWidth',1.5)
hold off

idx = 8;
plot(t,s(:,idx),'Color','red','LineWidth',1.5)
hold on
plot(t1,s1(:,idx),'--','Color','black','LineWidth',1.5)
hold off

plot(t,a(:,23),'Color','red','LineWidth',1.5)
hold on
plot(t1,a1(:,15),'--','Color','black','LineWidth',1.5)
hold off
